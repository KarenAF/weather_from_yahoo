class WeathersController < ApplicationController
  def index
    @city = params['city'].capitalize || 'Naperville'
    @state = params['state'].upcase || 'IL'
    ...
    @current_temp = @weathers['query']['results']['channel']['item']['condition']['temp']
    @forecast = @weathers['query']['results']['channel']['item']['forecast']
